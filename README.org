...
Choose ~Create a reach report~ in the guided app to export your complete photo gallery, its Wikipedia articles and language editions, and changes since your previous matching scan. You can optionally include the last 12 complete months of article pageviews. The HTML report opens in your browser and can be saved as a PDF using Print. It includes links to the photographs and the articles that use them.

The report shows past views of Wikipedia articles carrying your photos at scan time. Your photos may not have been on those pages for the whole reporting period. Article views do not measure how often someone saw your photos. Shared articles count once in the overall total. Your Main Page placements stay listed but are excluded from view totals because a brief appearance can inflate them. If the pageview service is unavailable or returns only some results, the report says so; missing measurements are never presented as measured zeroes.
...
The CSV contains one row per photograph and article placement. Existing export files are never overwritten.
...
This optional step fetches past pageviews for the Wikipedia articles found in your scan. The totals describe those articles' readership. They do not measure how often someone saw your photos, and they do not establish that your photos were present throughout the reporting period: if a photo was added yesterday, the article's views from last month still count. Main Page placements stay listed but their pageviews are excluded, because a single day on a Main Page can add millions of views. Credit Check asks each Wikipedia for its own Main Page title; if that lookup fails, views from that Wikipedia are deferred and the report says so. A photo used only on Main Pages shows as excluded, not as a measured zero. Article views saved by earlier versions stay hidden until you create a new reach report with article views.
