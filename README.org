...
<p align="center">
  <img src="assets/credit-check-hero.jpeg" alt="Credit Check screenshot showing selected Wikimedia Commons photos, Wikipedia usage, and a photographer category" width="100%">
</p>

That is the main workflow. If you also provide a category for photos of you and
a Wikidata QID, Credit Check can put photos of you taken by other people in a
...
4. *Sorts you from subjects.* Photos you took go one way. Photos that merely
   ...
   category, and can go to a category for photos of you instead.
...
photo status and puts the natural next action first: find your photos, choose
photos to add, or add the photos you picked. A separate optional action is always
...
to use. The
Settings action saves your Commons username, credited name, and photographer
category in [[file:.credit-check.json][.credit-check.json]] for this folder, so you do not have to
re-enter them.
...
photos of you by other people=; Credit Check looks up matching Wikidata items so
you can pick yourself, or skip cleanly if none of them are you. If you use direct
