...
That's it. Credit Check walks you through the rest: set up your Commons account
once, find your photos, pick the ones to add, and add them to your category.
...
That's it — =credit-check= now runs from anywhere. (=pip install credit-check=
works too.)
