...
your photos, pick the ones to add, and add them to your category.
...
articles in languages you don't even read. But there's no built-in way to see
which ones. Wikipedia happily uses your work; it just never tells you where.
...
Credit Check automates it. It finds the photos you took that Wikipedia is
actually using, and adds the ones you pick to your category — so you can finally
see, in one place, where your photos are used on Wikipedia.

I made this for my fellow WikiPortraits photographers. Wikipedians are
volunteers, so the least we can do is give credit where credit's due. That's why
I built Credit Check.
...
=Start over with a different photographer=; it clears saved details and current
found photos, then asks for the new photographer and searches again.
...
event or location categories. Its job is narrow on purpose: get your
Wikipedia-used photos into your photographer category.
